...
long_description = """
bacoli_py is a Python package for the error controlled numerical solution of 1D time-dependent PDEs.
wraps a slightly modified version of the BACOLI (see http://cs.stmarys.ca/~muir/bacoli-3_webpage.htm)
and BACOLRI solvers, written in Fortran. a tutorial, documentation, and examples can be found at
https://bacoli-py.readthedocs.io/en/latest/.
